...
import Poster4 from "../assets/Posters/Bocchi_the_Rock 21_Theater_Compilation_Key_Visual.png"
    ...
    export const posters = [
        ...
        {
            poster: Poster1,
            alt: "Bocchi_the_Rock 21_Anime_Main_Key_Visual"
        },

        {
            poster: Poster2,
            alt:"Blu-ray_ 26_DVD_Volume_5"
        },

        {
            poster: Poster3,
            alt:"Blu-ray_ 26_DVD_Volume_6"
        },

        {
            poster: Poster4,
            alt:"Bocchi_the_Rock 21_Theater_Compilation_Key_Visual"
        }
